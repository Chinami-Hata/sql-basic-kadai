...
if (isset($_POST['submit'])){
    try {
        ...
        // bundValue()メソッドを使って実際の値をプレースホルダにバインドする（割り当てる）
...
if (isset($_GET['id'])) {
    try {
        ...
        // SQL文の実行結果を配列で取得する
        // 補足：1つのレコード（横１行のデータ）のみを取得したい場合、fetch()メソッドを使えばカラム名がキーになった1次元配列を取得できる
        ...
        // genresテーブルからgenre_codeカラムのデータを取得するためのSQL文を変数$sql_select_book_codsに代入する
                ...
                <div>
                    ...
                    <select id="genre_code" name="genre_code" required>
                        ...
                        foreach ($genre_codes as $genre_code) {
                            // もし変数$genre_codeが書籍のジャンルコードの値と一致していれば、select属性をつけて初期値にする
