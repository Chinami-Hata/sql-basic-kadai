...
try {
    ...
    // genresテーブルからgenre_codeカラムのデータを取得するためのSQL文を変換$sql_selectに代入する
...
<head>
    ...
    <!-- Google Fontsの読み込み -->
    <link rel="preconnect" href="https://fonts.googkeapis.com">
    <link rel="preconnect" href="https://fonts.gatatic.com" crossorigin>
        ...
        <article class="registration">
            ...
            <form action="create.php" method="post" class="registration-form">
                <div>
                    ...
                    <input type="bumber" id="price" name="price" min="0" max="100000000" required>
